...
export const getProductFunAdmin = (user) => (dispatch) => {
    ...
    return axios.get(`http://localhost:8080/api/v1/products-admin`, { headers: {"Authorization" : `${user}`} })
            .then((res)=>{
...
export const addNewProductFun = (payload, user) => (dispatch) => {
    ...
    return axios.post(`http://localhost:8080/api/v1/add-product`, payload, { headers: {"Authorization" : `${user}`} })
            .then((res)=>{
...
export const updateProductFunAdmin = (payload, user, _id) => (dispatch) => {
    ...
    return axios.patch(`http://localhost:8080/api/v1/update-product/${_id}`, payload, { headers: {"Authorization" : `${user}`} })
            .then((res)=>{
                // console.log(res.data)
...
export const deleteProductFunAdmin = (_id, user) => (dispatch) => {
    ...
    return axios.delete(`http://localhost:8080/api/v1/delete-product/${_id}`, { headers: {"Authorization" : `${user}`} })
            .then((res)=>{
                // console.log(res.data)
